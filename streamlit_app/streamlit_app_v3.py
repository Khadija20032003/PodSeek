...
/* Aggressively center the vertical blocks holding these items */
...
/* Keep internal flex items natural but allow text centering */
...
st.markdown("<p style='text-align: center;'>Search the database to find exactly where a topic was discussed.</p>", unsafe_allow_html=True)
...
if not st.session_state.messages:
    ...
    # We will center the tags by placing them in a container that has text-align center applied by our CSS
    st.markdown('<div style="text-align: center;">', unsafe_allow_html=True)
    suggested_queries = ["Are autonomous cars safe?", "Who is Isaac Newton?", "What is intermittent fasting?"]
    
    # We create columns where the middle one acts as a center-aligned block
