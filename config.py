...
# CONTEXTBUILDING_FILES = "context_building_files"
...
# TRANSCRIPT_DIR = DATA_DIR /CONTEXTBUILDING_FILES / "full_podcast_transcript"
# SEGMENTS_DIR = DATA_DIR /CONTEXTBUILDING_FILES / "podcast_segments"
# CHUNKED_DIR = DATA_DIR /PREPROCESSING_FILES / "chunked_podcast_segments"
# ENRICHED_META_DIR = DATA_DIR / PREPROCESSING_FILES / "enriched_metadata"
# --- PROJECT STRUCTURE ---
PROJECT_ROOT = Path(__file__).resolve().parent          # PodSeek/
DATA_DIR = PROJECT_ROOT / "data"
...
EMBEDDING_OUTPUT_FILE = PREPROCESSING_FILES / "elastic_ready_with_embeddings.jsonl"
